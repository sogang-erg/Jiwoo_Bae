namespace UnityEditor.ShaderGraph
{
    ...
    internal static class FieldDependencies
    {
        ...
        public static DependencyCollection SurfaceDescription = new DependencyCollection
        {
            ...
            // UITK internal channels live in texCoord4-7 so texCoord0-3 are free for user UV0-UV3 (PanelSettings.extraVertexChannels).
            new FieldDependency(StructFields.SurfaceDescriptionInputs.uvClip,                                       StructFields.Varyings.texCoord4),
            new FieldDependency(StructFields.SurfaceDescriptionInputs.typeTexSettings,                              StructFields.Varyings.texCoord5),
            new FieldDependency(StructFields.SurfaceDescriptionInputs.textCoreLoc,                                  StructFields.Varyings.texCoord6),
            new FieldDependency(StructFields.SurfaceDescriptionInputs.layoutUV,                                     StructFields.Varyings.texCoord6),
            new FieldDependency(StructFields.SurfaceDescriptionInputs.circle,                                       StructFields.Varyings.texCoord7),
        };
