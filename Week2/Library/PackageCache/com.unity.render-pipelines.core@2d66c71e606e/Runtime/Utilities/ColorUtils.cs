namespace UnityEngine.Rendering
{
    ...
    {
        const float k_LightMeterCalibrationConstant = 12.5f;
        const float k_LensAttenuation = 0.65f;
        ...
        /// </summary>
        public static float s_LightMeterCalibrationConstant = k_LightMeterCalibrationConstant;
        ...
        /// </summary>
        public static float s_LensAttenuation = k_LensAttenuation;

#if UNITY_EDITOR
        [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.AfterAssembliesLoaded)]
        static void ResetStaticsOnLoad()
        {
            s_LightMeterCalibrationConstant = k_LightMeterCalibrationConstant;
            s_LensAttenuation = k_LensAttenuation;
        }
#endif
